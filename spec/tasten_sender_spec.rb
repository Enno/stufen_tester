...
describe TastenSender do
  ...
  it "should be able to control notepad" do
    ...
    sende_tasten('Editor', '%{F4}') # anderen Editor schlie�en, falls keine ungespeicherten �nderungen
    sende_tasten('Editor', nil).should == false # "Anderer Editor vorher schon ge�ffnet"
